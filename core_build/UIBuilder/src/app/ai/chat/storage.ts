...
export const customBaseURL = useLocalStorage(`${STORAGE_PREFIX}ai-base-url`, 'http://127.0.0.1:4000/v1')
export const customModelID = useLocalStorage(`${STORAGE_PREFIX}ai-custom-model`, 'coder-model')
